...
describe User do
  ...
  describe "when email fomat is invalid" do
    ...
    describe "when email fomat is valid" do
      it "should be valid" do
        addresses = %w[user@foo.COM A_US-ER@f.b.org first.lst@foo.jp a+b@baz.ua]
      ...
      describe  "when email addresse is alredy taken" do
        before do
      ...
      describe "return value of auteticate method" do
        before { @user.save }
